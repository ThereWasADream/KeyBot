...
namespace SteamTrade
{
    ...
    /// </summary>
    public partial class LiveTrade
    {
        ...
        internal LiveTrade(SteamID me, SteamID other, SteamWeb steamWeb, Task<Inventory> myInventoryTask, Task<Inventory> otherInventoryTask)
        {
            TradeStarted = false;
            OtherIsReady = false;
            MeIsReady = false;
        ...
        public delegate void WaitingForEmailHandler();

        public delegate void ErrorHandler(string errorMessage, string errorstatus);
